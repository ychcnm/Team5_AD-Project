var SpeRequisition = {
    ...
    init: function () {
        Common.init();
        SpeRequisition.bindEvent();
        $("#speRequisition").addClass("selected");
    ...
    bindEvent: function () {
        $("#category").on("click", '.in_border_c', function () {
            ...
            Request.Myajax(SpeRequisition.url + 'getReqStationery', JSON.stringify({ "categoryId": cid }), SpeRequisition.getReqStationerySuccess, SpeRequisition.getReqStationeryError);
        });
        $("#cartSubmit").on("click", function () {

            SpeRequisition.jsonData = SpeRequisition.getJsonData();
            Request.Myajax(SpeRequisition.url + 'makeRequisition', JSON.stringify({ "jsonStr": JSON.stringify(SpeRequisition.jsonData) }), SpeRequisition.makeRequisitionSuccess, SpeRequisition.makeRequisitionError)
        });
    ...
    getReqStationerySuccess: function (data) {
        ...
        SpeRequisition.drawItemsTable(inventoryList);
